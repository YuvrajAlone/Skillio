        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {isLoading ? (
            ...
            <div className="col-span-full text-center py-16">
              <div className="w-20 h-20 mx-auto mb-4 bg-linear-to-br from-accent/30 to-secondary/30 rounded-3xl flex items-center justify-center">
                <Trophy className="w-10 h-10 text-primary/70" />
              </div>
              <p className="text-lg font-semibold opacity-70 mb-1 text-blue-600/50">
                No sessions yet
              </p>
              <p className="text-sm opacity-50 text-white/70">
